package com.dftc.mqttclient.shadow;

import android.content.Context;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.dftc.mqttclient.iothub.ALiyunIotX509TrustManager;
import com.dftc.mqttclient.util.AliyunWebUtils;
...
public class SimpleClient4Shadow {
    ...
    public static void test(Context con) throws Exception {
        ...
        connectMqtt(con, targetServer, mqttClientId, mqttUsername, mqttPassword);
    }

    private static void connectMqtt(Context con, String url, String clientId, String mqttUsername,
                                    String mqttPassword) throws Exception {

        MemoryPersistence persistence = new MemoryPersistence();
        SSLSocketFactory socketFactory = createSSLSocket(con);

...
/**
 * 
 * @version $Id: ALiyunIotX509TrustManager.java, v 0.1 2017年3月10日 下午4:34:07 Exp $
 */
public class ALiyunIotX509TrustManager extends X509ExtendedTrustManager{
    ...
    private X509TrustManager rootTrusm;
     ...
     public ALiyunIotX509TrustManager(Context context) throws Exception{
         //CA根证书，可以从官网下载
         InputStream in = context.getAssets().open("root.crt");//SimpleClient4IOT.class.getResourceAsStream("/root.crt");
